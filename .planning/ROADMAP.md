...
- [x] 26-01-PLAN.md *(wave 1)*
- [x] 26-02-PLAN.md *(wave 1)*
- [x] 26-03-PLAN.md *(wave 2)*

Gap-closure plans, added 2026-07-29 by `/gsd-plan-phase 26 --gaps` to close the
...
- [x] 26-06-PLAN.md *(wave 4, blocked on wave 3)* — the release executor core (Truth 9)
- [x] 26-07-PLAN.md *(wave 5, blocked on wave 4)* — `--execute`/`--yes-release` CLI surface (Truths 7, 10)
